...
import com.example.onieon.configuration.servlet.handler.BaseHandlerInterceptor;
import com.example.onieon.framework.data.web.SQLPageRequestHandleMethodArgumentResolver;
...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> resolvers) {
        resolvers.add(new SQLPageRequestHandleMethodArgumentResolver());
    }
}
